Create a Claude Code sub-agent named "Echo".

YAML frontmatter (save as `.claude/agents/echo.md`):
- name: echo
...
- Read the plan file, `forge/implementation.md`, and `sentinel/review.md` before writing anything.
